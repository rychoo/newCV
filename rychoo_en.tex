...
\photo[51pt]{0} % also optional, and the optional argument is the height the picture must be resized to
...
\cventry{2006--2007}{Workman}{JobServer}{Denmark}{{\color{ser}CPR: 030270-2683}}{Making of steel constructions, installation of equipment in piggery, the construction of silos for DanSystem \mbox{Industri} {\itshape\color{see}(\weblink{http://www.dansystemindustri.dk/})}; completing the orders on forklift truck in warehouse of frozen goods  \mbox{Frigoscandia} {\itshape\color{see}(\weblink{http://www.frigoscandia.dk/})}; worker of warehouse auto parts, wheel balancing in T. Hansen Gruppen {\itshape\color{see}(\weblink{http://www.thansen.dk/})}; driver. \hfill{\itshape\color{see}\footnotesize{}See \weblink{http://www.tnspolska.pl/}.}}
...
\section{Interests}
\cvitem{\small social skills and competences}{\small I'm an Internet fan, as a technique for connecting computers using TCP/IP, and as a sociological phenomena connecting people. You can say about me ''unix guru'' ({\itshape\color{see} \mbox{see} \weblink{http://www.bsdguru.org/node/76} i \weblink{http://www.bsdguru.org/node/48}}), I'm using network actively and have its own website where I test my ideas ({\itshape\color{see} see \weblink{http://czekaj.net.pl/}}).}
